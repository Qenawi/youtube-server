...
from myproject.myapp.features.Analytics.model.AnalyticModule import AnalyticModule as mModel
...
def insert(my_request: HttpRequest):
    print(my_request)
    book = mModel.build_item(dic={"title": "@TestBook", "analytic_amount": 100})
